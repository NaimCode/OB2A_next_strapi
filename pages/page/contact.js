...
const contact = ({email,adresse}) => {
    ...
    return (
      ...
      <p class="leading-relaxed my-5 text-gray-600">Besoin des informations? Ou pour un partenariat?</p>
<section class="text-gray-600 body-font relative ">
  <div class=" bg-white shadow-2xl container px-5 py-10 mx-auto flex md:flex-row flex-col md:justify-between space-x-4">
    ...
    <div class="mapouter "><div className="gmap_canvas  ">
      <iframe width="741" height="500" id="gmap_canvas"
       src="https://maps.google.com/maps?q=caen&t=&z=17&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://putlocker-is.org"></a><br/>
    ...
    <div class="w-20 bg-white flex flex-col md:ml-auto  md:py-8 mt-8 md:mt-0">
      ...
      <div class="relative mb-4">
        <label for="email" class="leading-7 text-sm text-gray-600">Objet</label>
